...
method_name_values=(T5_APAO_Pairwise T5_APAO_Pairwise T5_APAO_Pairwise T5_APAO_Pairwise Llama_APAO_Pairwise Llama_APAO_Pairwise Llama_APAO_Pairwise Llama_APAO_Pairwise)
SEED=42
beam_size=20
test_bsz=512

beta_values=(0.2 0.1 0.1 0.05 0.4 0.2 0.4 0.1)
eta_values=(3e-5 5e-5 1e-4 5e-6 5e-5 3e-5 1e-5 5e-6)
